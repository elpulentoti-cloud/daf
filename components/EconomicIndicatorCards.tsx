  ...
  return (
    <div className="flex overflow-x-auto space-x-6 pb-6 no-scrollbar scroll-smooth">
      {indicators.map((ind, i) => (
        <div key={i} className="flex-shrink-0 w-52 bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:border-mason-gold/40 transition-all duration-300 group hover:-translate-y-1">
          <div className="flex items-center justify-between mb-4">
            <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-blue-900 group-hover:bg-mason-gold group-hover:text-blue-950 transition-colors">
